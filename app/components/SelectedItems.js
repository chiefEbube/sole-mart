            ...
            <div key={index} className={`h-[150px] flex items-center justify-between ${padding ? 'mr-10' : 'mr-2'} py-2 ${index !== items.length - 1 ? 'border-b' : ''} border-[#d6d4d4]`}>
              <div className='flex items-center gap-5'>
                ...
                <div className='flex flex-col gap-5'>
                  ...
                  <p className='openSans font-light text-sm'><span className='font-normal'>Color:</span> <span className='text-[#646261]'>Creamy</span></p>
                  <p className='text-md flex items-center inter font-bold'>
                    <TbCurrencyNaira className='text-2xl' />{product?.current_price[0].NGN}
                  </p>
                </div>
              </div>
            ...
            <div key={index} className={`h-[150px] flex items-center justify-between gap-6 py-2`}>
              <div className='flex items-center gap-5'>
                ...
                <div className='flex flex-col gap-4'>
                  ...
                  <p className='openSans font-light text-xs'><span className='font-normal'>Color:</span> <span className='text-[#646261]'>Creamy</span></p>
                  <p className='text-xs flex items-center inter font-bold'>
                    <TbCurrencyNaira className='text-sm' />{roduct?.current_price[0].NGN}
                  </p>
                </div>
              </div>
