    ...
    <div className="container mx-auto mb-16">
      <div className="grid grid-cols-1 md:grid-cols-2 w-11/12 mx-auto my-10">
        ...
        <div className="flex flex-col justify-evenly">
          <h1 className="mb-2 font-bold text-5xl uppercase text-[#231F20] poppins">{product.name}</h1>
          ...
          <p className="poppins text-[#0000007a] my-4">{product.description}</p>
          <section className="flex poppins text-base text-[#526475] gap-5 font-medium">
            <div className="flex items-center bg-[#f1f1f0] py-3 px-4  rounded-3xl">
              <span>Class</span>
            </div>
            <div className="flex items-center bg-[#f1f1f0] py-2 px-4 rounded-3xl">
              <span>Comfort</span>
            </div>
          </section>
          <div>
            <button onClick={() => addToCart(product.id)} className="w-10/12 bg-secondaryBg text-plainWhite text-sm rounded-3xl inter font-semibold hover:opacity-90 duration-300 mt-12 py-4">Add to Cart
            </button>
          </div>
        </div>
      </div>
